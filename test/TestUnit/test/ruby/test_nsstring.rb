...
class TestNSString < Test::Unit::TestCase
  ...
  def test_ASET # '[]='
    ...
    assert_raise(ArgumentError) { S("foo")[1, 2, 3] = "" }
  end
  ...
  def test_delete
    ...
    # assert_equal("a".hash, S("a\u0101").delete("\u0101").hash, '[ruby-talk:329267]')
    # assert_equal(true, S("a\u0101").delete("\u0101").ascii_only?)
    # assert_equal(true, S("a\u3041").delete("\u3041").ascii_only?)
    assert_equal(false, S("a\u3041\u3042").tr("\u3041", "a").ascii_only?)
  ...
  def test_sub
    ...
    assert_raise(IndexError) { S("foo")[/(?:(o$)|(x))/, 2] = 'bar' }
