class StringSpec_Mock1 < Java::Lang::Object
  def to_s
    '42'
  end
end

class StringSpec_Mock2 < Java::Lang::Object
  def to_s
    42
  end
end
...
=begin
  # FIXME class variables are not yet implemented
